          ...
          {({ handleChange, handleBlur, handleSubmit, values, errors, touched }: any) => (
            <View style={styles.formContainer}>
              ...
              <View style={styles.controlsContainer}>
                  ...
                  <Text style={styles.termsAndCondition}>Al presionar confirmar usted acepta nuestros terminos y condiciones </Text>
                  <View style={styles.buttonBox}>
                    <Button appearance='filled' color={colors.primary} handleClick={handleSubmit} rounded >CONFIRMAR</Button>
                  </View>
