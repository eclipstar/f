...
const styles = StyleSheet.create({
  box: {
    ...
    borderRadius: 25, // Se aplica el borde superior izquierdo redondeado
    elevation: 4, // Nivel de elevación para generar una sombra en Android
  },
});